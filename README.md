...
This fork exists because the VERSION spec used in the upstream package does not adhere to [PEP 440](https://peps.python.org/pep-0440/).
Once [kubevirt#14634](https://github.com/kubevirt/kubevirt/pull/14634) is merged and released this fork can be deleted.

Links:
- https://peps.python.org/pep-0440/
- https://github.com/kubevirt/client-python/issues/60
- https://github.com/kubevirt/kubevirt/pull/14634

For now, we're just rebasing with the upstream default branch and modifying the VERSION string (similar to the PR linked above).
...
- API version: 1.0.0
- Package version: v1.6.0-beta.0-125
